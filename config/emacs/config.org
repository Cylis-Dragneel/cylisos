...
#+OPTIONS: toc:2
#+PROPERTY: header-args:emacs-list :tangle yes
...
(use-package dashboard
  ...
  (setq initial-buffer-choice 'dashboard-open
        ...
        dashboard-startup-banner "/home/cylis/.config/emacs/images/emacs-dash.png"
...
* ELCORD
A plugin to get discord-rich-presence
#+begin_src emacs-lisp
(use-package elcord
  :config
...
(use-package ligature
  :load-path "path-to-ligature.el" ; Replace with actual path if not using MELPA
  :config
